# Qport/Session Execution Implementation Wrapper CI Risk Table
...
| --- | --- | --- |
| Fixture drift | Implementation CI manifest, fixture hashes, and offline fixture validator | Stop and review fixture policy. |
